...
solutions = OOES("./Model.lp",pareto_frontier=true,mipsolver=4, threads=8,parallelization=3,timelimit=1000.0)
...
for i in 1:length(solutions) 
	...
	df_output_2[!, 2][i]= ((1/1000000)*solutions[i].obj_vals[2]) #1,000,000
	df_output_2[!, 3][i]= ((1/907185)*solutions[i].obj_vals[3]) #907185
end
